...
class HistoryFragment : Fragment(),VehicleAdapter.OnItemClickListener {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        vehicleList = mutableListOf(
            Vehicle("AP39CZ9999", "Mahindra", "Mahindra XUV700","8","InProgress"),
            Vehicle("TS01AB0098", "Maruthi", "Vitara Brezza","9","InProgress"),
            Vehicle("GSGB3B8849", "Mahindra", "Mahindra XUV500","10","Completed"),
            Vehicle("TS01AB9004", "Honda", "CIAZ","12","InProgress"),
            Vehicle("KA01AB1234", "Toyota", "Toyota Fortuner","15","Completed"),
            Vehicle("TN10XY4567", "Honda", "Honda Civic","21","Completed")
        )
