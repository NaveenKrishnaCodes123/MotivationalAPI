...
import com.mindcoin.dservicevp.Model.VehicleViewCheckOutFactory
import com.mindcoin.dservicevp.Model.VehicleViewModelItemFactory
...
class CheckOutActivity : AppCompatActivity() {
   ...
   // private lateinit var checkmarkImage: ImageView
    ...
    private fun showSuccessAnimation() {
        ...
        val timeText = dialogView.findViewById<TextView>(R.id.confirmedTimeText)
        val checkmarkImage = dialogView.findViewById<ImageView>(R.id.checkmarkImage)
        timeText.text = timeEditText.text.toString().trim()
