...
import com.mindcoin.dservicevp.Model.LogoutRequest
import com.mindcoin.dservicevp.Model.LogoutResponse
import com.mindcoin.dservicevp.Model.UpdatePasswordRequest
import com.mindcoin.dservicevp.Model.UpdatePasswordResponse
import com.mindcoin.dservicevp.Model.UploadResponse
import com.mindcoin.dservicevp.Model.VehicleCheckInRequest
import com.mindcoin.dservicevp.Model.VehicleCheckInResponse
import com.mindcoin.dservicevp.Model.VehicleDetailResponse
import com.mindcoin.dservicevp.Model.VehicleDetailsByHookNumberRequest
import com.mindcoin.dservicevp.Model.login.LoginRequest
import com.mindcoin.dservicevp.Model.login.LoginResponse
import com.mindcoin.dservicevp.Model.login.VehicleResponse
import com.mindcoin.dservicevp.Model.parkingslots.ParkingResponse
import com.mindcoin.dservicevp.selfUpdate.AppSelfUpdate
...
interface ApiService {
    ...
    @POST("valetparkingapi/deviceToken/addUpdate")
    suspend fun addOrUpdateDeviceToken(@Header("Authorization") authToken: String,@Body request: DeviceTokenRequest): Response<DeviceTokenResponse>
}