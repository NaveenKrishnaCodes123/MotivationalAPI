...
import com.mindcoin.dservicevp.Model.UpdatePasswordFactory
import com.mindcoin.dservicevp.R
import com.mindcoin.dservicevp.Resource
import com.mindcoin.dservicevp.activity.LoginActivity
...
import com.mindcoin.dservicevp.viewModel.AuthViewModel
import com.mindcoin.dservicevp.viewModel.VehicleViewModel.UpDatePasswordViewModel
...
class ProfileFragment : Fragment() {
    ...
    private fun upDatePasswordAPICall(oldPassword: String,newPassword: String,dialog: Dialog) {
        ...
        upDatePasswordViewModel.isLoading.observe(viewLifecycleOwner, Observer { isLoading ->
            ProgressBarUtility.showProgressDialog(requireContext())
        })
