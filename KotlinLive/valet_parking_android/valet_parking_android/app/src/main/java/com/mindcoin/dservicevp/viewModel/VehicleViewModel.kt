...
import com.mindcoin.dservicevp.Model.VehicleDetail
...
import com.mindcoin.dservicevp.Model.login.Vehicle
...
class VehicleViewModel {
    ...
    class DeviceTokenViewModel(private val repository: VehicleRepository) : ViewModel() {

        private val _tokenResponse = MutableLiveData<Result<DeviceTokenResponse>>()
        val tokenResponse: LiveData<Result<DeviceTokenResponse>> = _tokenResponse

        fun registerDeviceToken(authToken: String,request: DeviceTokenRequest) {
            viewModelScope.launch {
                val result = repository.addOrUpdateToken("Bearer $authToken",request)
