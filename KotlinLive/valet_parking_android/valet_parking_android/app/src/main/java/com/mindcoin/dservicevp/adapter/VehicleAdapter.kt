    ...
    inner class VehicleViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(vehicle: Vehicle, position: Int) {
            ...
            outTime.text = if (!TextUtils.isEmpty(vehicle.outTime)) {
                ...
                if (!TextUtils.isEmpty(vehicle.checkOutRequestedTime)) {
                    "Requested Time: ${convertDateFormat(vehicle.checkOutRequestedTime.toString())}"
                } else {
                    "Check Out: --/--/-- --:--"
                }
            }
           ...
           /* if(vehicle.checkOutRequestedType==1){
